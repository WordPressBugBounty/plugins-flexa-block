...
class Block_Manager {
	...
	const BASE_BLOCKS = [
		...
		[
			...
			'name'        => 'flexa/button',
			'title'       => 'Button',
			'description' => 'Theme-aware call-to-action button with variants, sizes, icons, hover colors and per-device typography.',
			'category'    => 'design',
		...
		[
			...
			'name'        => 'flexa/heading',
			'title'       => 'Heading',
			'description' => 'Rich heading with optional subheading and separator, per-device typography, light/dark colors, gradient text and text effects.',
			'category'    => 'design',
		...
		[
			...
			'name'        => 'flexa/image',
			'title'       => 'Image',
			'description' => 'Media image with per-device width and alignment, aspect-ratio lock, object-fit, shape masks, color/gradient overlay, hover motion, caption and link or lightbox.',
			'category'    => 'design',
		...
		[
			...
			'title'       => 'Countdown',
			'description' => 'Live countdown to a target date with selectable units, separators, labels, per-device typography, light/dark colors and a completion action.',
			'category'    => 'design',
		...
		[
			...
			'name'        => 'flexa/faq',
			'title'       => 'FAQ',
			'description' => 'Expandable question-and-answer accordion with open-state icons, dividers, per-question and answer styling, light/dark colors and optional FAQ schema.',
			'category'    => 'design',
		...
		[
			...
			'title'       => 'Social Share',
			'description' => 'Row of share buttons that post the current page — or the current WooCommerce product — to Facebook, X, LinkedIn or Pinterest, with per-device size, gap, alignment, a button shape, official brand or custom-tinted icons, optional network names and a hover motion.',
			'category'    => 'design',
		...
		[
			...
			'name'        => 'flexa/text',
			'title'       => 'Text',
			'description' => 'Rich paragraph with per-device alignment, typography, solid or gradient text color, hover color, stroke and shadow effects, blend mode and a drop cap.',
			'category'    => 'design',
		...
		[
			...
			'title'       => 'Separator',
			'description' => 'Horizontal divider line with per-device width, thickness and alignment, a solid/dashed/dotted/double style and light/dark color.',
			'category'    => 'design',
		...
		[
			...
			'title'       => 'Testimonial',
			'description' => 'Single testimonial card - star rating, headline, quote and an author block (avatar, name, role) with per-device typography, spacing, alignment and light/dark colors.',
			'category'    => 'design',
		...
		[
			...
			'name'        => 'flexa/counter',
			'title'       => 'Counter',
			'description' => 'Grid of stat counters that count up when scrolled into view — each with an icon, a prefixed/suffixed number and a label, plus per-device columns, typography, light/dark colors and a per-item box.',
			'category'    => 'design',
		...
		[
			...
			'name'        => 'flexa/info-box',
			'title'       => 'Info Box',
			'description' => 'Icon or image paired with a prefix, title and description, an optional divider and a call-to-action button. Media sits above or beside the text, with per-device typography, spacing and light/dark colors.',
			'category'    => 'design',
			...
			[
				...
				'title'       => 'Breadcrumb',
				'description' => 'Hierarchical breadcrumb trail — auto-built from the current page\'s ancestors or listed by hand, with a home icon, a chosen separator, link / current / separator colors, per-device typography and optional BreadcrumbList schema.',
				'category'    => 'design',
			...
			[
				...
				'name'        => 'flexa/tabs',
				'title'       => 'Tabs',
				'description' => 'Organise content into a horizontal tab bar with optional icons, an underline, pill or boxed tab style, per-tab and content typography, light/dark colors, and a bar that collapses to an accordion on mobile.',
				'category'    => 'design',
			...
			[
				...
				'description' => 'Multi-image gallery in a grid, masonry or justified-tiled layout with per-device columns and gap, hover motion, color or gradient overlay, captions and a prev/next lightbox.',
				'category'    => 'design',
			...
			[
				...
				'name'        => 'flexa/banner',
				'title'       => 'Banner',
				'description' => 'Promotional banner / hero section — a heading, description and call-to-action buttons laid over a color, gradient or image background with an overlay, a banner min-height and boxed or full width.',
				'category'    => 'design',
			...
			[
				...
				'title'       => 'Pricing Table',
				'description' => 'Side-by-side pricing plans — each column carries a name, price, billing period, feature list, a highlighted "most popular" flag and a call-to-action, with an optional monthly/yearly toggle, per-device typography and light/dark colors.',
				'category'    => 'design',
			...
			[
				...
				'title'       => 'Team Member',
				'description' => 'Profile card for one team member — a photo, name, role and bio with linked social icons, the photo placed above, left or right of the text, per-element typography, light/dark colors and hover accents.',
				'category'    => 'design',
			...
			[
				...
				'name'        => 'flexa/rss',
				'title'       => 'RSS Feed',
				'description' => 'Show the newest entries from any RSS or Atom feed URL as a list or grid — set how many items, cache time and sort order, toggle the thumbnail, title, date, author, source and excerpt, add a read-more link that can open in a new tab, and style the card typography, colors and button.',
				'category'    => 'design',
			...
			[
				...
				'title'       => 'Progress Bar',
				'description' => 'Animated progress indicator in a line, circle or semi-circle layout — set the value as a percentage or absolute count, show a title and counter, choose fill and track colors (light/dark), a solid or striped fill and an on-scroll fill animation.',
				'category'    => 'design',
			...
			[
				...
				'name'        => 'flexa/timeline',
				'title'       => 'Timeline',
				'description' => 'Chronological timeline of events — each entry with a title, description, date, an optional image and a marker icon, arranged down a connector line alternating left/right or on a single side, with per-element typography, marker and line styling and light/dark colors.',
				'category'    => 'design',
			...
			[
				...
				'name'        => 'flexa/icon',
				'title'       => 'Icon',
				'description' => 'A single SVG glyph — chosen from the icon library or uploaded — with per-device size and alignment, a default, stacked or framed view in a square, rounded or circle shape, icon and frame colors with hover, and an optional link.',
				'category'    => 'design',
			...
			[
				...
				'title'       => 'Icon List',
				'description' => 'A list or grid of icon-and-text rows — each with its own glyph, label and link — with the icon before or after the text, per-device columns and gaps, block-level icon styling (size, view, shape, colors with hover, frame) and text typography and colors.',
				'category'    => 'design',
			...
			[
				...
				'title'       => 'Star Rating',
				'description' => 'A star rating shown out of a chosen maximum — set the value and range, the star size, gap and marked/unmarked colors, lay it out inline or stacked with an optional title, and expose an aggregateRating schema.',
				'category'    => 'design',
			...
			[
				...
				'name'        => 'flexa/modal',
				'title'       => 'Modal',
				'description' => 'A pop-up dialog opened by a button, text, image or icon trigger and filled with any inner blocks — set the modal width, max-height, padding, background and radius, the overlay color, the close button, and show-once, click-overlay and press-escape behaviour.',
				'category'    => 'design',
			...
			[
				...
				[
					...
					'name'        => 'flexa/notice',
					'title'       => 'Notice',
					'description' => 'Highlight an announcement, tip or warning — pick an info, success, warning, danger or neutral style, show an icon beside or above the text, add a title and message, align it, and let visitors dismiss it (optionally remembering the dismissal), with per-element typography and light/dark colors.',
					'category'    => 'design',
				...
				[
					...
					'description' => 'Display recent Instagram media from an access token (fetched server-side and cached) — in a grid, hover-overlay, card or carousel layout with per-device columns, square or original thumbnails, an optional caption, date and profile name, links that open the post, and caption typography and colors.',
					'category'    => 'design',
				...
				[
					...
					'title'       => 'Product Name',
					'description' => 'Show the current WooCommerce product’s title on a single-product page — pick the heading tag, optionally link it to the product, and style typography, color or gradient, hover color, stroke, shadow, spacing, background, border, shadow and light/dark colors.',
				...
				[
					...
					'description' => 'Show the current WooCommerce product’s average star rating on a single-product page — display stars, a numeric score or both, an optional review count, and style the star size, gap, filled and empty star colors, the numeric-score color and typography, and the review-count typography and colors.',
					'category'    => 'woocommerce',
					'is_woo'      => true,
				...
				[
					...
					'description' => 'Show the current WooCommerce product’s details on a single-product page as tabs — toggle the Description, Additional information and Reviews tabs, and style the tab titles (normal and active colors, typography, padding, gap) and the content area (typography, color, padding), with a paginated Reviews list (numbered or load-more), per-element Reviews styling (title, author, date, stars, text) and Additional-information table styling (label/value colors + typography, cell borders and padding).',
					'category'    => 'woocommerce',
					'is_woo'      => true,
				...
				[
					...
					'title'       => 'Product Image',
					'description' => 'Show the current WooCommerce product’s images on a single-product page — the featured image with a thumbnail carousel (bottom, left or right) showing a set number of thumbnails per view, a per-device gap, image scale, height or adaptive height, zoom-on-hover, optional autoplay, radius and alignment. On a variable product the featured image follows the shopper’s chosen options, and clicking it can open the gallery full screen.',
					'category'    => 'woocommerce',
					'is_woo'      => true,
				...
				[
					...
					'name'        => 'flexa/product-description',
					'title'       => 'Product Description',
					'description' => 'Show the current WooCommerce product’s long description on a single-product page — add an optional heading above it, and style the body typography and color, the link colors, the headings, lists and tables nested inside the description, and optionally clamp it to a set number of lines behind a Read more toggle. For the short description use Product Excerpt.',
					'category'    => 'woocommerce',
					'is_woo'      => true,
					'generator'   => 'Flexa\Block\CSS_Generators\Product_Description_CSS',
				],
				[
					'slug'        => 'product-stock',
					'name'        => 'flexa/product-stock',
					'title'       => 'Product Stock',
					'description' => 'Show the current WooCommerce product’s stock status on a single-product page — as plain text or a badge, with your own wording for in stock, out of stock and on backorder, an optional status icon, the remaining quantity, a low-stock threshold with its own colors, and per-status text and background colors plus badge padding and radius.',
					'category'    => 'woocommerce',
					'is_woo'      => true,
					'generator'   => 'Flexa\Block\CSS_Generators\Product_Stock_CSS',
				],
				[
					'slug'        => 'product-field',
					'name'        => 'flexa/product-field',
					'title'       => 'Product Field',
					'description' => 'One line of WooCommerce product data on a single-product page — the SKU, the categories or the tags — with an optional label beside or above it. Terms read inline with a separator, as badges or as a list, each linking to its archive; the SKU can carry a prefix, a suffix, fallback wording and a copy-to-clipboard button. Use it on its own, or stack several inside Product Meta.',
					'category'    => 'woocommerce',
					'is_woo'      => true,
					'generator'   => 'Flexa\Block\CSS_Generators\Product_Field_CSS',
				],
				[
					'slug'        => 'product-meta',
					'name'        => 'flexa/product-meta',
					'title'       => 'Product Meta',
					'description' => 'Stack the current WooCommerce product’s fields — SKU, categories, tags — as rows of one list on a single-product page. Add, remove and reorder the rows like any blocks; the list owns the label column, the gap between rows and the divider, and sets the label and value styling every row starts from.',
					'category'    => 'woocommerce',
					'is_woo'      => true,
					'generator'   => 'Flexa\Block\CSS_Generators\Product_Meta_CSS',
				],
				[
					'slug'        => 'product-excerpt',
					'name'        => 'flexa/product-excerpt',
					'title'       => 'Product Excerpt',
					'description' => 'Show the current WooCommerce product’s short description on a single-product page — falling back to a trimmed long description when the short one is empty, capped at a word count or a number of lines, with typography, text color and link colors you control.',
					'category'    => 'woocommerce',
					'is_woo'      => true,
					'generator'   => 'Flexa\Block\CSS_Generators\Product_Excerpt_CSS',
				],
				[
					'slug'        => 'product-add-to-cart',
					'name'        => 'flexa/product-add-to-cart',
					'title'       => 'Add to Cart',
					'description' => 'Put the current WooCommerce product’s add-to-cart form on a single-product page — quantity field and button side by side, stacked, or the button on its own, with your own button label and cart icon, quantity-field sizing, colors, border and radius, full button styling for the normal and hover states, and matching styling for the attribute dropdowns of variable products.',
					'category'    => 'woocommerce',
					'is_woo'      => true,
					'generator'   => 'Flexa\Block\CSS_Generators\Product_Add_To_Cart_CSS',
				],
				[
					'slug'        => 'product-related',
					'name'        => 'flexa/product-related',
					'title'       => 'Related Products',
					'description' => 'Show products related to the current WooCommerce product — as a responsive grid or a vertical list, with a product count, ordering, per-device columns and gaps, toggles for the image, title, price, rating and add-to-cart button on each card, card background, padding, radius, outline and shadow, image ratio and hover motion, and an optional section heading.',
					'category'    => 'woocommerce',
					'is_woo'      => true,
					'generator'   => 'Flexa\Block\CSS_Generators\Product_Related_CSS',
				],
	];
